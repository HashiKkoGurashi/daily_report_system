        ...
        if(servletPath.matches("/css.*")) {
            ...
            if(ev == null) {
                ...
                if(!(ForwardConst.ACT_AUTH.getValue().equals(action) && (ForwardConst.CMD_SHOW_LOGIN.getValue().equals(command) || ForwardConst.CMD_LOGIN.getValue().equals(command)))) {
                    ...
                    ((HttpServletResponse)response).sendRedirect(contextPath + "?action=" + ForwardConst.ACT_AUTH.getValue() + "&command=" + ForwardConst.CMD_SHOW_LOGIN.getValue());
                ...
                if(ForwardConst.ACT_AUTH.getValue().equals(action)) {
                    ...
                    if(ForwardConst.CMD_SHOW_LOGIN.getValue().equals(command)) {
                        ...
                        ((HttpServletResponse)response).sendRedirect(contextPath + "?action=" + ForwardConst.ACT_TOP.getValue() + "&command=" + ForwardConst.CMD_INDEX.getValue());
                        return;
